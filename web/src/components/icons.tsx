...
/** Simplified rendering of the W&B "beads" mark: three dot columns of
 *  alternating sizes. Recognizable without reproducing the trademark art. */
export function WandbIcon({ size = 18 }: { size?: number }) {
  return (
